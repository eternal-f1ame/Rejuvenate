...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'places512': dict(ref_gpus=8,  kimg=5,  mb=64, mbstd=8,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=8),
        'celeba256': dict(ref_gpus=8,  kimg=250,  mb=64, mbstd=8,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=8),
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', 'stylegan2', 'paper256', 'paper512', 'inp512', 'paper1024', 'cifar', 'places256', 'places512', 'celeba512','celeba256']))
